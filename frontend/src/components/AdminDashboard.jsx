            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div className="bg-slate-800 shadow rounded-lg p-6">
                        ...
                        <p className="text-3xl font-bold text-white">150</p> {/* Replace with actual data */}
                    </div>

                    <div className="bg-slate-800 shadow rounded-lg p-6">
                        <h3 className="text-lg font-semibold text-gray-300 mb-2">Total Products</h3>
                        <p className="text-3xl font-bold text-white">280</p> {/* Replace with actual data */}
                    </div>

                    <div className="bg-slate-800 shadow rounded-lg p-6">
                        <h3 className="text-lg font-semibold text-gray-300 mb-2">New Orders</h3>
                        <p className="text-3xl font-bold text-white">25</p> {/* Replace with actual data */}
                    </div>

                    <div className="bg-slate-800 shadow rounded-lg p-6">
                        <h3 className="text-lg font-semibold text-gray-300 mb-2">Out of Stock Products</h3>
                        <p className="text-3xl font-bold text-red-500">12</p> {/* Replace with actual data */}
                    </div>
                    ...
                    <div className="bg-slate-800 shadow rounded-lg p-6">
                        ...
                        <ul className="list-disc pl-5 text-gray-300">
                            ...
                            <li>User 2</li>
                            <li>User 3</li>
                        </ul> {/* Replace with actual data */}
                    </div>

                    <div className="bg-slate-800 shadow rounded-lg p-6">
                        <h3 className="text-lg font-semibold text-gray-300 mb-2">System Status</h3>
                        <p className="text-green-400 font-semibold">Online</p> {/* Replace with actual data */}
                    </div>
                </div>
            </div>
        </div>
